    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewMedicinesButton.setOnClickListener(v -> {
            ...
            for (String medicine : medicineList) {
                LinearLayout medicineLayout = new LinearLayout(MainActivity.this);
                medicineLayout.setOrientation(LinearLayout.HORIZONTAL);

                TextView medicineTextView = new TextView(MainActivity.this);
                ...
                deleteButton.setOnClickListener(v1 -> {
                    ...
                    Toast.makeText(MainActivity.this, medicine + "이 삭제되었습니다.", Toast.LENGTH_SHORT).show();
        ...
        clearDatabaseButton.setOnClickListener(v -> {
            ...
            Toast.makeText(MainActivity.this, "모든 복용약 데이터가 삭제되었습니다.", Toast.LENGTH_SHORT).show();
        });
    }
    ...
    private void showAddMedicineDialog() {
        ...
        builder.setPositiveButton("추가", (dialog, which) -> {
            ...
            if (!medicineName.isEmpty() && !dosage.isEmpty() && !time.isEmpty() && !category.isEmpty()) {
                ...
                Toast.makeText(MainActivity.this, "복용약이 추가되었습니다.", Toast.LENGTH_SHORT).show();
            } else {
